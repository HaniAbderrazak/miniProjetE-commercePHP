...
<body>
    ...
    <main>
        <div class="container">
            ...
            $gp=new GestionCommande();
            
       // $tab2=$gu->RecupererUserById(($_SESSION['nom']);
       // foreach($tab2 as $donne)
       // {
       //   $id=$donne['Id'];
       // }
         $tab1=$gp->RecupererCommande();
   ...
   foreach($tab1 as $donne)
       {
          $tab2=$gp->RecupererProduitsDansCommande($donne['idCommande']);       
         
          //$tab2=$gu->RecupererUserById($donne['']);
          $tab3=$gu->RecupererUserById($donne['idUserC']); 
                                      foreach ($tab3 as $value) {
                                        # code...
                                        echo "<h3 style='margin-top:20px;'> Nom User : ".$value['Email']."<br> prixTotale :".$donne['prixTotale']."<br> Date Commande :".$donne['dateC']."</h3>" ;
                                      foreach($tab2 as $d)
                                   {
                                  $tab=$gs->RecupererProduitParId($d['idProduit']);
                    ...
                    <div class="card d-flex flex-row mb-3">
                        <div class="d-flex flex-grow-1 min-width-zero">
                            <div class="card-body align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center">
                               ...
                               <p class="mb-0 text-muted text-small w-15 w-xs-100"><?php echo $produit['nomProd']; ?></p>
                               <p class="mb-0 text-muted text-small w-15 w-xs-100"><?php echo $produit['diametre'] ; ?></p>
                                
                               <p class="mb-0 text-muted text-small w-15 w-xs-100"><?php echo $produit['Prix'] ; ?></p>
                               <p class="mb-0 text-muted text-small w-15 w-xs-100"><?php echo $produit['image'] ; ?></p>
                               <p class="mb-0 text-muted text-small w-15 w-xs-100"><?php echo $d['quantite'] ; ?></p>
            ...
            <a href="ajouterProduits.php"class="btn btn-primary btn-block">Passe Commande</a>
