...
include "../Controllers/GestionCategorie.php";
  ...
  $Id=$_GET["IdCategorie"];
  $tab=$gs->RecupererCategorieById($Id);
  $n=count($tab);
        ?>
      <?php for($i=0;$i<$n;$i++) { ?>
            <form action="UpdateCate.php" method="post" class="form">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                       ...
                       <input type="text" name="nomCateg" class="form-control" placeholder="<?php echo $tab[$i]['nomCateg'] ;?>">
                      <input type="hidden" name="IdCategorie" class="form-control" value="<?php echo $tab[$i]['IdCategorie'] ;?>">
                    
                     <input type="submit" name="button" class="btn btn-primary btn-block" value="Update Categorie"/>
                    </div>
                      </div>
                      </form>
                    </div>
