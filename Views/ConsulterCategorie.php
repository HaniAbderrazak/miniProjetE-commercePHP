...
<html lang="en">
  ...
  <body>
   ...
   <?php for($i=0;$i<$n;$i++) { ?>
                    ...
                    <div class="card d-flex flex-row mb-3">
                        <div class="d-flex flex-grow-1 min-width-zero">
                            <div class="card-body align-self-center d-flex flex-column flex-md-row justify-content-between min-width-zero align-items-md-center">
                               ...
                               <a href="DeleteCategorie.php?IdCategorie=<?php echo $tab[$i]['IdCategorie'] ;?>" class="mb-0 text-muted text-small w-15 w-xs-100"> 
                              ...
                              <path fill-rule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
                                ...
                                <a href="UpdateCategorie.php?IdCategorie=<?php echo $tab[$i]['IdCategorie'] ;?>" class="mb-0 text-muted text-small w-15 w-xs-100">
            ...
            <a href="ajouterCategorie.php"class="btn btn-primary btn-block">Ajouter Categorie</a>
          </body>
